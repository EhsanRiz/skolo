  ...
  if (done) return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <h2 style={{ color: '#0f172a', marginBottom: 8 }}>Password Reset</h2>
        <p style={{ color: '#64748b', marginBottom: 24 }}>Your password has been updated.</p>
      ...
      <div style={{ flex: 1, padding: '24px 20px', maxWidth: 400, margin: '0 auto', width: '100%' }}>
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: 16 }}>
            <label style={{ display: 'block', fontSize: 13, fontWeight: 500, color: '#334155', marginBottom: 6 }}>New Password</label>
