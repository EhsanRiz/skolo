        ...
        <div style={{ background:'#fff', borderRadius:18, padding:'32px', boxShadow:'0 4px 24px rgba(0,0,0,.08)' }}>
          ...
          {step === 'invalid' && (
            <div style={{ textAlign:'center' }}>
              ...
              <a href="/login" style={{ display:'inline-block', padding:'10px 24px', background:'#0f2044', color:'#fff', borderRadius:9, textDecoration:'none', fontWeight:700, fontSize:14 }}>
                Go to login →
              </a>
            </div>
          )}
          ...
          {step === 'valid' && invite && (
            <>
              <div style={{ marginBottom:24 }}>
                <div style={{ fontSize:11, fontWeight:700, color:'#94a3b8', textTransform:'uppercase', letterSpacing:'0.6px', marginBottom:4 }}>Welcome to Skolo</div>
                <div style={{ fontSize:20, fontWeight:800, color:'#0f172a', marginBottom:4 }}>{invite.full_name}</div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button type="submit" disabled={saving || !password || !confirm}
                  style={{ width:'100%', padding:'13px', background: saving ? '#4b6a9e' : '#0f2044', color:'#fff', border:'none', borderRadius:9, fontWeight:700, fontSize:15, cursor: saving ? 'not-allowed' : 'pointer', transition:'background .15s' }}>
