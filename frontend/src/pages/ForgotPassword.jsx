        ...
        <div style={{ background: '#fff', borderRadius: 18, padding: 32, boxShadow: '0 4px 24px rgba(0,0,0,.08)' }}>
          {sent ? (
            <div style={{ textAlign: 'center', padding: '12px 0' }}>
              ...
              <div style={{ fontWeight: 800, fontSize: 18, color: '#1f2937', marginBottom: 8 }}>Check your inbox</div>
              <div style={{ fontSize: 14, color: '#6b7280', lineHeight: 1.6, marginBottom: 24 }}>
                If <strong>{email}</strong> is registered, you'll receive a reset link shortly.
                The link expires in 1 hour.
              </div>
              <Link to="/login" style={{ display: 'inline-block', padding: '10px 24px', background: '#003049', color: '#fff', borderRadius: 9, textDecoration: 'none', fontWeight: 700, fontSize: 14 }}>
                Back to login →
              </Link>
            </div>
          ) : (
            <>
              <div style={{ marginBottom: 24 }}>
                ...
                <div style={{ fontSize: 20, fontWeight: 800, color: '#1f2937', marginBottom: 4 }}>Forgot your password?</div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <input
                  ...
                  autoFocus
                  style={{ width: '100%', padding: '11px 14px', border: '1.5px solid #e5e7eb', borderRadius: 9, fontSize: 14, outline: 'none', marginBottom: error ? 8 : 20, boxSizing: 'border-box' }}
                />
                ...
                <button type="submit" disabled={loading} style={{ width: '100%', padding: 13, background: loading ? '#4b6a9e' : '#003049', color: '#fff', border: 'none', borderRadius: 9, fontWeight: 700, fontSize: 15, cursor: loading ? 'not-allowed' : 'pointer', transition: 'background .15s' }}>
